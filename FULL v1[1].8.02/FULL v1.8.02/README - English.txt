...
1) Copy FuelS.pwn, FuelS.amx, Check.pwn and Check.amx into FilterScripts folder
2) Copy FuelSystem.txt,CheckpointsFiles.txt and FuelConf.txt into your scriptfiles folder
