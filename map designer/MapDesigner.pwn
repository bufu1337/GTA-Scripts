...
{
	print("\n----------------------------------");
	print(" [ SAMP - Map Designer | Ver: 0.14 ]- by KAPIL ");
	print("----------------------------------\n");
}
...
{
	print("\n----------------------------------");
	print(" [ SAMP - Map Designer ]- by KAPIL ");
	print("----------------------------------\n");
}
...
{
	if (strcmp("/osel", cmdtext, true) == 0)
	{
		GetPlayerPos(playerid,x,y,z);
		SetPlayerCameraPos(playerid,x+10,y+10,z+100);
		dis = 10;
...
MoveObject(objectid,x1+0.5,y1,z1,2);
}
else if(direction == 2){
GetObjectPos(objectid,x1,y1,z1);
MoveObject(objectid,x1,y1+0.5,z1,2);

}
else if(direction == 3){
GetObjectPos(objectid,x1,y1,z1);
MoveObject(objectid,x1,y1,z1+0.5,2);
...
pid = playerid;
SetTimerEx("GetKeys1",200,0,"i",playerid);
if (keys == 1){
new key1;
new key2;
new key3;
...
SetTimerEx("GetKeys2",50,0,"i",playerid);
if (keys == 1){
new key1;
new updown;
new key3;
...
if (updown == KEY_DOWN){
print("X- DOWN KEY");
SetPlayerCameraPos(playerid,x+dis+2,y+dis+2,z+100);
SetPlayerCameraLookAt(playerid,x,y,z+100);
dis = dis + 2;
}
if (updown == KEY_UP ){
...
SetTimerEx("GetKeys3",100,0,"i",playerid);
new key1;
new key2;
new key3;
GetPlayerKeys(playerid,key1,key2,key3);
...
if (type == 1){
SetObjectRot(objectid,rx+4,ry,ry);
}
else if(type == 3){
SetObjectRot(objectid,rx,ry,rz+4);
}
else if(type == 2){
SetObjectRot(objectid,rx,ry+4,rz);
}
}
