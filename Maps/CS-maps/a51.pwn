...
public OnGameModeInit()
{
	...
	AddPlayerClass(285,153.4940,1884.7892,18.2068,267.2003,31,4000,25,100,17,18); // CTA51
	AddPlayerClass(179,253.0293,1845.0245,8.7652,39.8866,30,4000,25,100,17,18); // TA51

    CreateObject( 971 , 96.843200 , 1921.461791 , 20.619607 , 0.000000 , 0.000000 , 86.000000 );
...
//---------------------WELCOME MESSAGE-----------------------------
	...
	SendClientMessage(playerid,WHITE_COLOR, "GameMode: Area 51");
