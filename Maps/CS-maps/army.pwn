...
public OnGameModeInit()
{
 ...
 AddPlayerClass(285,-1128.8424,1062.7542,1345.7357,225.5879,31,4000,25,100,17,18); // CTArmy
	AddPlayerClass(179,-978.8110,1060.8595,1345.3883,91.1666,30,4000,25,100,17,18); // TArmy
...
//---------------------WELCOME MESSAGE-----------------------------
	...
	SendClientMessage(playerid,WHITE_COLOR, "GameMode: Army Base");
...
public mapname()
{
    SendRconCommand("mapname Army Base");
	return 1;
}
