...
public OnGameModeInit()
{
	...
	AddPlayerClass(285,2318.0811,2445.4099,3.2734,96.5310,31,4000,25,100,17,18); // CTLvPD
	AddPlayerClass(179,2313.4629,2495.3745,-7.4531,88.6742,30,4000,25,100,17,18); // TLvPD


    CreateObject( 972 , 2316.470458 , 2445.280517 , 0.790983 , 0.000000 , 0.000000 , 0.000000 );
...
//---------------------WELCOME MESSAGE-----------------------------
	...
	SendClientMessage(playerid,WHITE_COLOR, "GameMode: LVPD Station");
...
public mapname()
{
    SendRconCommand("mapname LVPD Station");
	return 1;
}
