  /*============================================================================================*\
   ||The Follow Filterscript was created by [SDT]Orpheus, You may only use this Filterscript for ||
   ||your gamemode, you may not distribute it, unless given permission by myself, This script    ||
   || has taken me a long time to do, and I would be happy to allow it to be used in a gamemode  ||
   || especially an FUN server, you may add to the script if you wish but this Does NOT!!! make  ||
   || it your's so you CANNOT edit or removed the print for on Filterscriptinit or these Credit. ||
   ||           Enjoy the filterscript, I will be happy to add to it, on request Regards Orpheus :D  ||
   \*============================================================================================*/

/*====================================================*\
|| This Is a BASE Filterscript, and requires than you ||
|| Add certain lines below onto your COMMANDS or other||
|| Events that occur  e.g "OnGameModeInit() etc, this ||
|| Filterscript it just for fun, and has no REAL use  ||
|| I have included TEST commands and it is simple     ||
|| Enough to add the neccisary lines to your commands ||
|| --------Generally its for a good laugh :P!---------||
|| --Enjoy The randomness Filterscript people, Orph!--||
\*====================================================*/
// If you need any help with any of the functions, message me on the boards.
...
{0xFF66FF}, {0xFF66CC}, {0xFF66CC}, {0xFF6666}, {0xFF6633}, {0xFF6600},
{0xFF33FF}, {0xFF33CC}, {0xFF3399}, {0xFF3399}, {0xFF3333}, {0xFF3300},
...
{0x0000FF}, {0x0000CC}, {0x000099}, {0x000066}, {0x000033}, {0x000000}
};
...
new gRandomSound[][] = {
{1002}, {1009}, {1027}, {1035}, {1036}, {1039},
{1052}, {1053}, {1054}, {1055}, {1056}, {1057},
{1058}, {1062}, {1063}, {1068}, {1069}, {1076},
{1077}, {1083}, {1084}, {1085}, {1097}, {1098},
{1130}, {1131}, {1132}, {1133}, {1134}, {1135},
{1136}, {1137}, {1138}, {1139}, {1140}, {1141},
{1142}, {1143}, {1144}, {1145}, {1147}, {1148},
{1149}, {1150}, {1153}, {1154}, {1163}, {1165},
{1166}, {1169}, {1183}, {1184}, {1185}, {1186},
{1187}, {1188}, {1002}, {1009}, {1020}, {1021},
{1022}, {1027}, {1035}, {1039}, {1052}, {1053},
{1054}, {1055}, {1056}, {1057}, {1058}, {1062},
{1068}, {1076}, {1083}, {1084}, {1085}, {1095},
{1097}, {1100}, {1101}, {1130}, {1131}, {1132},
{1133}, {1134}, {1135}, {1136}, {1137}, {1138},
{1139}, {1140}, {1141}, {1142}, {1144}, {1145},
{1147}, {1148}, {1149}, {1150}, {1153}, {1159},
{1163}, {1165}, {1183}, {1185}, {1187}, {1190}
};
new gRandomPickup[][] = {
...
{1324}, {1325}, {1559}, {321}, {322}, {323},
{324}, {325}, {326}, {330}, {331}, {333},
...
public OnFilterScriptInit()
{
        ...
        print("-Loading Weathers, skins, Weapons, Sounds, Colours, Pickups, and positions-");
        print("-------------------------Created By [SDT]Orpheus--------------------------");
        print("-------------------------Released 27th july 2008--------------------------");
        print("==========================================================================");
        print("\n");
        return 1;
}
...
dcmd(TESTW, 5, cmdtext);
dcmd(TESTC, 5, cmdtext);
dcmd(TESTA, 5, cmdtext);
dcmd(TESTH, 5, cmdtext);
dcmd(TESTS, 5, cmdtext);
dcmd(TESTP, 5, cmdtext);
dcmd(TESTC2, 6, cmdtext);
dcmd(TESTW2, 6, cmdtext);
dcmd(TESTS2, 6, cmdtext);
dcmd(TESTP2, 6, cmdtext);
return 0;
}

dcmd_TESTW(playerid,params[])
{
#pragma unused params
#pragma unused playerid
new randWe = random(sizeof(gRandomWeathers));
SetWeather(gRandomWeathers[randWe][0]);
return 1;
}
dcmd_TESTC(playerid,params[])
{
#pragma unused params
new randCont = random(sizeof(gRandomControl));
TogglePlayerControllable(playerid,gRandomControl[randCont][0]);
return 1;
}
dcmd_TESTA(playerid,params[])
{
#pragma unused params
new randAAH = random(sizeof(gRandomARMANDHP));
SetPlayerArmour(playerid,gRandomARMANDHP[randAAH][0]);
return 1;
}
dcmd_TESTH(playerid,params[])
{
#pragma unused params
new randAAH = random(sizeof(gRandomARMANDHP));
SetPlayerHealth(playerid,gRandomARMANDHP[randAAH][0]);
return 1;
}
dcmd_TESTS(playerid,params[])
{
#pragma unused params
new randSou = random(sizeof(gRandomSound));
new Float: X; new Float: Y; new Float: Z;
GetPlayerPos(playerid, X, Y, Z);
PlayerPlaySound(playerid,gRandomSound[randSou][0],X,Y,Z);
return 1;
}
dcmd_TESTP(playerid,params[])
{
#pragma unused params
new randPOS = random(sizeof(gRandomPosition));
new randHeight = random(sizeof(gRandomHeight));
SetPlayerPos(playerid, gRandomPosition[randPOS][0],gRandomPosition[randPOS][0], gRandomHeight[randHeight][0]);
return 1;
}
dcmd_TESTC2(playerid,params[])
{
#pragma unused params
new randCOL = random(sizeof(gRandomCOLOURS));
SetPlayerColor(playerid,gRandomCOLOURS[randCOL][0]);
return 1;
}
dcmd_TESTP2(playerid,params[])
{
#pragma unused params
new Float: X; new Float: Y; new Float: Z;
GetPlayerPos(playerid, X, Y, Z);
new randPick = random(sizeof(gRandomPickup));
new randType = random(sizeof(gRandomPickupType));
CreatePickup(gRandomPickup[randPick][0],gRandomPickupType[randType][0],X,Y,Z);
return 1;
}

dcmd_TESTS2(playerid,params[])
{
#pragma unused params
new randSk = random(sizeof(gRandomSkin));
SetPlayerSkin(playerid,gRandomSkin[randSk][0]);
return 1;
}
dcmd_TESTW2(playerid,params[])
{
#pragma unused params
new randAMMO = random(sizeof(gRandomAMMO));
new randWeps = random(sizeof(gRandomWeapons));
GivePlayerWeapon(playerid, gRandomWeapons[randWeps][0],gRandomAMMO[randAMMO][0]);
return 1;
}
