...
{
    SendClientMessageToAll(COLOR_WHITE," Script of animations loaded. Help: /animhelp");
}

public OnFilterScriptExit()
{
    SendClientMessageToAll(COLOR_WHITE," Script of animations unloaded.");
}

public OnPlayerConnect(playerid)
{
	SendClientMessage(playerid,COLOR_WHITE," Script of animations loaded. Help: /animhelp");
return 1;
}

// ðàáîòàþò 1730 èç 1749
...
// Àíèìàöèè
	...
	{
		SendClientMessage(playerid,COLOR_GREEN," ‡‡‡‡‡‡‡‡‡‡ Animation by OKStyle™ ‡‡‡‡‡‡‡‡‡‡");
        SendClientMessage(playerid,COLOR_LIGHTRED," Syntax: /anim id animid.");
        SendClientMessage(playerid,COLOR_LIGHTRED," List of animations: /animlist, /animlist2");
		SendClientMessage(playerid,COLOR_LIGHTRED," To stop animation: /stop");
	...
	if(!strcmp(cmd, "/animlist2", true))
	{
		...
		SendClientMessage(playerid,COLOR_BODY,"/animshotgun, /animsilenced, /animskate, /animsmoking, /animsniper, /animspraycan");
	...
	if(GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
	{
		...
		if(!strcmp(cmd, "/animattractors", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animat [1-3]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbar", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbar [1-12]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbdfire", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfire [1-13]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbeach", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbeach [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbenchpress", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbp [1-7]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbf", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbf [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbiked", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbiked [1-19]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbikeh", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbikeh [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbikeleap", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbikelp [1-9]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbikes", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbikes [1-20]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbikev", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 18)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbikev [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbikedbz", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbikedbz [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbmx", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 18)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbmx [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbomber", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbomber [1-6]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbox", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbox [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbsktball", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbasket [1-41]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbuddy", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbuddy [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animbus", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 9)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbus [1-9]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcamera", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcamera [1-14]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcar", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 11)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcar [1-11]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcarry", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 7)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcarry [1-7]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcarchat", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcarchat [1-21]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcasino", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcasino [1-25]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animchainsaw", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 11)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animsaw [1-11]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animchoppa", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 18)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animchoppa [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animclothes", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 13)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animclothes [1-13]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcoach", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 6)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcoach [1-6]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcolt", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 7)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcolt [1-7]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcopambient", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 12)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcopa [1-12]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcopdvbyz", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcopdvb [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcrack", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcrack[1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animcrib", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animcrib [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animdamjump", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animdamjump [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animdancing", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 13)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animdance [1-13]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animdealer", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 7)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animdealer [1-7]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animdildo", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 9)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animdildo [1-9]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animdodge", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animdodge [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animdozer", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animdozer [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animdrivebys", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animdrivebys [1-8]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfat", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 18)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfat [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfightb", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfightb [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfightc", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 12)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfightc [1-12]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfightd", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfightd [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfighte", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfighte [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfinale", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfinale [1-16]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfinale2", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 8)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfinale2 [1-8]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animflowers", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 3)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animflowers [1-3]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfood", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfood [1-33]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animfreeweights", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 9)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animfw [1-9]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animgangs", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 33)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animgangs [1-33]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animghands", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 20)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animghands [1-20]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animghetto", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 7)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animghettodb [1-7]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animgraffity", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animgraffity [1-2]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animgraveyard", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 3)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animgreya [1-3]");
				return 1;
				}
				switch(animid)
				{
		...
		if(strcmp(cmd, "/animgrenade", true) == 0)
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 3)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animgren [1-3]");
				return 1;
				}
			switch(animid)
			{
		...
		if(!strcmp(cmd, "/animgym", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animgym [1-24]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animhaircut", true))
		{
    		...
    		animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 13)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animhaircut [1-13]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animheist", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animheist [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animinthouse", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animinthouse [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animintoffice", true))
		{
    		...
    		animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animintoffice [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animintshop", true))
		{
    		...
    		animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 8)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animintshop [1-8]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animjst", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animjst [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animkart", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animkart [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animkissing", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animkissing [1-15]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animknife", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 16)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animknife [1-16]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animlapdan", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 2)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animlapdan [1-2]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animlowrider", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animlowrider [1-39]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animmdchase", true))
		{
    		...
    		animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 25)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animmdchase [1-25]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animmddend", true))
		{
			...
			if(!strlen(tmp)||animid < 1 || animid > 8)
			{
				SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animmddend [1-8]");
			return 1;
			}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animmisc", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 41)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animms [1-41]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animmtb", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 18)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animmtb [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animmusculcar", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animmusculcar [1-17]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animnevada", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 2)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animnevada [1-2]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animonlookers", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animlookers [1-29]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animotb", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 11)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animotb [1-11]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animparachute", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animpara [1-22]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animpark", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 3)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animpark [1-3]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animpaulnmac", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 12)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animpaulnmac [1-12]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animped", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animped [1-295]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animplayerdvbys", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animplayerdvbys [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animplayidles", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animplayidles [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animpolice", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animpolice [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animpool", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 21)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animpool [1-21]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animpoor", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 2)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animpoor [1-2]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animpython", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animpython [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animquad", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 17)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animquad [1-17]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animquadbz", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animquadbz [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animrapping", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 8)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animrapping [1-8]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animrifle", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animrifle [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animrobbank", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animrobbank [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animrocket", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animrocket [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animrustler", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animrustler [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animryder", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 16)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animryder [1-16]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animscratching", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 12)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animscratching [1-12]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animshamal", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animshamal [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animshop", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 25)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animshop [1-25]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animshotgun", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 3)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animshotgun [1-3]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animsilenced", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animsilenced [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animskate", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 3)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animskate [1-3]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animsmoking", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 8)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animsmoking [1-8]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animspraycan", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 2)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animspraycan [1-2]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animstrip", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 20)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animstrip [1-20]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animsunbathe", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 18)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animbath [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animswat", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animswat [1-23]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animsweet", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 7)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animsweet [1-7]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animswim", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 7)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animswim [1-7]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animsword", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 10)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animsword [1-10]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animtank", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 6)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animtank [1-6]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animtattoos", true))
		{
			...
			animid = strval(tmp);
				...
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animtattoos [1-57]");
				return 1;
				}
				switch(animid)
				{
		...
		if(strcmp(cmd, "/animtec", true) == 0)
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animtec [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animtrain", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animtrain [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animtruck", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 17)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animtruck [1-17]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animuzi", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 5)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animuzi [1-5]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animvan", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 8)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animvan [1-8]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animvending", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 6)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animvending [1-6]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animvortex", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animvortex [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animwayfarer", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 18)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animway [1-18]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animweap", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 17)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animweap [1-17]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animwuzi", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 12)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animwuzi [1-12]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animsnm", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 8)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animsnm [1-8]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/animblowjob", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 12)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /animblowjob [1-12]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/dance", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 4)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /dance [1-4]");
				return 1;
				}
				switch(animid)
				{
		...
		if(!strcmp(cmd, "/phone", true))
		{
			...
			animid = strval(tmp);
				if(!strlen(tmp)||animid < 1 || animid > 2)
				{
					SendClientMessage(playerid,COLOR_SYSTEM," Syntax: /phone [1-2]");
				return 1;
				}
				switch(animid)
				{
	...
	else return SendClientMessage(playerid,COLOR_RED," Animations are inaccessible in transport!");
return 0;
}
