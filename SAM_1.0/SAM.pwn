...
new Float:area69 [4] = {-72.9683,1642.7612,434.1817,2139.6919};
public SAM_timer()
{
...
public SAM_lunch(playerid)
{
	...
	{
		SAM[playerid][0] = CreateObject(3790, 14.939204, 1720.225097, 24.630422, 0.000000, 30.000000, 270.000000);
		SAM_T[playerid][0] =SetTimerEx("SAM_go", 500, 1, "d d", playerid, 0);
		CreateExplosion(14.939204, 1720.225097, 24.630422, 4, 1);
	}
}
